...
const Greeting = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-500 mt-1">{now.toLocaleString()}</p>
    </div>
  );
};
import {
  ...
  return (
    <div
      className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-5 flex items-center gap-4
                 hover:border-gray-300 dark:hover:border-gray-700 shadow-sm transition-colors cursor-pointer"
      onClick={onClick}
...
const ActivityItem = ({ item }) => (
  <div className="p-3 bg-white dark:bg-transparent border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition">
...
export default function Dashboard() {
  ...
  return (
    <div className="
  max-w-5xl mx-auto px-6 pt-12 pb-6
...
">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {sessions.map((s) => (
                      <tr
                        key={s.id}
                        className="hover:bg-gray-50 dark:hover:bg-gray-800 transition border-b border-gray-100 dark:border-gray-800 last:border-0"
                      >
  ...
  transition-colors cursor-pointer text-left"
          >
            ...
            <h3 className="text-gray-900 dark:text-white font-semibold mb-1">Invite Candidate</h3>
  ...
  transition-colors cursor-pointer text-left"
          >
            ...
            <h3 className="text-gray-900 dark:text-white font-semibold mb-1">Add Problem</h3>
  ...
  transition-colors cursor-pointer text-left"
          >
            ...
            <h3 className="text-gray-900 dark:text-white font-semibold mb-1">View Progress</h3>
  ...
  rounded-xl p-5
  hover:bg-gray-50 dark:hover:bg-gray-800
  transition-colors cursor-pointer text-left cursor-not-allowed">
            <div className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-700/40 border border-gray-200 dark:border-gray-700 flex items-center justify-center mb-4">
